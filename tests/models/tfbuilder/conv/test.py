...
class OpGenerator:
  def __init__(self, IHW, KHW, IC, OC, stridesHW, dilationHW, tflite_dtype=tf.float32):
...
def genOP():
    ...
    op = OpGenerator(IHW, KHW, IC, OC, stridesHW, dilationHW, tflite_dtype=tflite_dtype)
