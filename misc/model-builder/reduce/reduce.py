...
class OpGenerator:
    def __init__(self, elementWiseOp, shape, axis, keepdims, tflite_dtype=tf.float32):
    ...
    def genTensorFlowModel(self):
        ...
        with tf.Session(graph=tf.Graph()) as sess:
            ...
            net = self.op(net, axis=axis, keepdims=keepdims, name=self.oname)
...
def genOP():
    ...
    op = OpGenerator(reduceOP, shape, axis, keepdims, tflite_dtype=tflite_dtype)
